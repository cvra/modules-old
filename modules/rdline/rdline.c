...
static void rdline_miniprintf(struct rdline * rdl, const char * buf, uint8_t val);
...
void rdline_init(struct rdline *rdl, rdline_write_char_t *write_char,
		         rdline_validate_t *validate, rdline_complete_t *complete) {
...
static void display_right_buffer(struct rdline * rdl) {
	uint8_t i;
	char tmp;
...
char *rdline_get_history_item(struct rdline * rdl, uint8_t idx) {
	uint8_t len, i, tmp;
...
/* les attributes sont necessaire pour eviter un warning. */
int8_t rdline_add_history(__attribute__((unused)) struct rdline * rdl, __attribute__((unused)) const char * buf) {return -1;}
void rdline_clear_history(__attribute__((unused)) struct rdline * rdl) {}
char * rdline_get_history_item(__attribute__((unused)) struct rdline * rdl,__attribute__((unused)) uint8_t i) {return NULL;}
