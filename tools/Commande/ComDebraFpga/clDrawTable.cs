...
namespace ComDebraFpga
{
	public class clDrawTable
	{
		...
		internal clDrawTable(PictureBox inPic, clMain M)
		{
			...
			lstAvoid[lstAvoid.Count - 1].Add(new Point(0, 320));
			lstAvoid[lstAvoid.Count - 1].Add(new Point(580, 320));
			lstAvoid[lstAvoid.Count - 1].Add(new Point(580, 680));
			lstAvoid[lstAvoid.Count - 1].Add(new Point(0, 680));
			lstAvoid.Add(new List<Point>());
			lstAvoid[lstAvoid.Count - 1].Add(new Point(0, 2000));
			lstAvoid[lstAvoid.Count - 1].Add(new Point(505, 2000));
			lstAvoid[lstAvoid.Count - 1].Add(new Point(543, 1080));
			lstAvoid[lstAvoid.Count - 1].Add(new Point(0, 1080));
			lstAvoid.Add(new List<Point>());
			lstAvoid[lstAvoid.Count - 1].Add(new Point(795, 695));
			lstAvoid[lstAvoid.Count - 1].Add(new Point(1405, 695));
			lstAvoid[lstAvoid.Count - 1].Add(new Point(1405, 1305));
			lstAvoid[lstAvoid.Count - 1].Add(new Point(795, 1305));
			lstAvoid.Add(new List<Point>());
			lstAvoid[lstAvoid.Count - 1].Add(new Point(1405, 1180));
			lstAvoid[lstAvoid.Count - 1].Add(new Point(1595, 1180));
			lstAvoid[lstAvoid.Count - 1].Add(new Point(1595, 820));
			lstAvoid[lstAvoid.Count - 1].Add(new Point(1405, 820));

			lstAvoid.Add(new List<Point>());
			lstAvoid[lstAvoid.Count - 1].Add(new Point(3000, 320));
			lstAvoid[lstAvoid.Count - 1].Add(new Point(2420, 320));
			lstAvoid[lstAvoid.Count - 1].Add(new Point(2420, 680));
			lstAvoid[lstAvoid.Count - 1].Add(new Point(3000, 680));
			lstAvoid.Add(new List<Point>());
			lstAvoid[lstAvoid.Count - 1].Add(new Point(3000, 2000));
			lstAvoid[lstAvoid.Count - 1].Add(new Point(2495, 2000));
			lstAvoid[lstAvoid.Count - 1].Add(new Point(2457, 1080));
			lstAvoid[lstAvoid.Count - 1].Add(new Point(3000, 1080));
			lstAvoid.Add(new List<Point>());
			lstAvoid[lstAvoid.Count - 1].Add(new Point(2205, 695));
			lstAvoid[lstAvoid.Count - 1].Add(new Point(1595, 695));
			lstAvoid[lstAvoid.Count - 1].Add(new Point(1595, 1305));
			lstAvoid[lstAvoid.Count - 1].Add(new Point(2205, 1305));
		...
		internal void Paint(System.Drawing.Graphics graphics)
		{
			...
			Dessin.TranslateTransform(DistCentreBras, 0);
			// Distance bras
